...
Each checkpoint should begin with a scoped task packet in:

- `docs/bridge/NEXT_ACTION.md`

Nyx should begin by reading:
...
Nyx should finish by updating:

- `docs/bridge/NYX_REPORT.md`
- `docs/bridge/BLOCKERS.md` when needed
- `docs/bridge/COMMAND_LOG.md`

The user should bring `NYX_REPORT.md` back to Nova/chat for review and next-step planning.
