...
This is a compressed print-side artifact format. P123 merged this path into
main together with sparse target consumption and cascaded target support. It
does not replace the dense P117 mini textbook path, does not run training or a
real burn, and does not change Pallas or WKV runtime semantics.
...
P123 merged the reviewed P119-P122 cascade pipeline into main. The dense P117
burn path remains preserved.
...
bucket summaries. P122 adds optional bucket-shape loss.
