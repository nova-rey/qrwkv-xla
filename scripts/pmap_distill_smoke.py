...
from qrwkv_xla.distributed.distill_pmap import (
    PmapDistillSkip,
    prepare_pmap_distill_smoke,
    run_pmap_distill_smoke,
)


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run a skip-safe multi-device pmap distillation smoke"
    )
    ...
    prepared = prepare_pmap_distill_smoke(config, device_count_cap=args.device_count)
    ...
    result = run_pmap_distill_smoke(config, device_count_cap=args.device_count)
