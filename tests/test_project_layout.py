...
REQUIRED_PATHS = [
    ...
    ROOT / "corpora" / "smoke_prompts.manifest.json",
    ...
    ROOT / "scripts" / "resolve_qwen_policy.py",
    ROOT / "scripts" / "inspect_prompt_corpus.py",
    ROOT / "scripts" / "create_prompt_manifest.py",
    ROOT / "scripts" / "split_prompt_corpus.py",
    ...
    ROOT / "src" / "qrwkv_xla" / "prompting" / "__init__.py",
    ROOT / "src" / "qrwkv_xla" / "prompting" / "corpus.py",
    ROOT / "src" / "qrwkv_xla" / "prompting" / "hash.py",
    ROOT / "src" / "qrwkv_xla" / "prompting" / "split.py",
